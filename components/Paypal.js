...
const Paypal = ({values, set, setResult}) => {
    ...
    return (
        ...
        <button
          ...
          className="focus:outline-none hover:bg-green-400 py-4 px-2 text-white bg-green-500 rounded-lg font-display font-bold text-lg transition"
        >
          Atras
        </button>
