    ...
    return (
        <div className="w-full relative">
            ...
            <div className="w-full">
                <input className="font-display w-full text-gray-500 border-2 transition duration-500 focus:border-4 focus:border-green-500 border-gray-200 text-md focus:outline-none py-2 pl-2 rounded" {...field} {...props}></input>
            </div>
