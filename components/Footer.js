...
const Footer = () => {
  return (
    <>
      <div className="w-full h-96 grid place-items-center overflow-hidden">
        <div className="image h-96 w-full absolute z-0 opacity-90" />
        
        <div className="grid grid-cols-3 gap-20 max-w-screen-lg relative z-10">
